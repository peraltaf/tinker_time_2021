...
;(function($){
	...
	var $doc = $(document),
		...
		RangePicker.prototype = {
			...
			init : function(){
				...
				this.picker.addClass('picker-hider');
				var that 		  = this,
					presetWrap    = this.picker.find('.preset'),
					presetDefault = this.settings.defaultDate,
					years 		  = '',
					months 		  = '',
			...
			show : function(){
				...
				this.picker.removeClass('d-none picker-hider');
			...
			hide : function(){
				...
				this.picker.addClass('d-none picker-hider');
	...
	$.fn.rangePicker.defaults = {
	  ...
	  presets : [{
	      ...
	      displayText : moment().subtract(1, 'month').format('MMM YYYY'),
	      value       : '1m'
	    },{
	      buttonText  : 'Last 3 Months',
	      displayText : `${moment().subtract(3, 'month').format('MMM YYYY')} - ${moment().subtract(1, 'month').format('MMM YYYY')}`,
	      value       : '3m'
	    },{
	      buttonText  : 'Last 6 Months',
	      displayText : `${moment().subtract(6, 'month').format('MMM YYYY')} - ${moment().subtract(1, 'month').format('MMM YYYY')}`,
	      value       : '6m'
	    },{
	      buttonText  : 'Last 12 Months',
	      displayText : `${moment().subtract(12, 'month').format('MMM YYYY')} - ${moment().subtract(1, 'month').format('MMM YYYY')}`,
	      value       : '12m'
	    },{
	      buttonText  : 'Current Year',
	      displayText : `${moment().subtract(1, 'month').startOf('year').format('MMM YYYY')} - ${moment().subtract(1, 'month').format('MMM YYYY')}`,
	      value       : 'current_year'
	    },{
	        buttonText  : 'Custom',
	  ...
	  minDate : [5,2013],
	  maxDate : [+moment().subtract(1, 'month').format('MM'), +moment().subtract(1, 'month').format('YYYY')],
	  setDate : null
	}
