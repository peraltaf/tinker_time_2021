(function (global, factory) {
    ...
    function VennDiagram() {
        var width = 600,
            ...
            colourScheme = ['#7cb5ec', '#434348', '#90ed7d', '#f7a35c', '#8085e9', '#f15c80', '#e4d354', '#2b908f', '#f45b5b', '#91e8e1'],
            colourIndex = 0,
        ...
        function chart(selection) {
            ...
            if (data.length > 0) {
                ...
                let svg = d3.select(`#${selection._groups[0][0].id}`).append('svg')
                    .attr('width', width)
                    .attr('height', height)
                    .append('g')
                ...
                svg.append('text')
                    ...
                    .style('stroke','#ccc')
                    .style('font-family', 'Maven Pro, Roboto, sans-serif')
                    .style('fill','#ccc')
                    .attr('x', (width/2))
                    .attr('y', height/2);
